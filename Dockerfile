...
##   $ docker build -t php-for-farzam65-wordpress .
##
## RUNNING
##   $ docker run -p 9000:9000 php-for-farzam65-wordpress
##
## CONNECTING
...
ENV STACKSMITH_STACK_ID="okznroy" \
    STACKSMITH_STACK_NAME="PHP for farzam65/WordPress" \
